...
urlpatterns = [
    ...
    path('shareholders/cash-report/all-pdf/', views_frontend.shareholder_cash_report_all_pdf, name='shareholder_cash_report_all_pdf'),
    path('monthly-planner/', views_frontend.monthly_purchase_planner, name='monthly_purchase_planner'),
    path('monthly-planner/history/', views_frontend.monthly_plan_history, name='monthly_plan_history'),
    path('monthly-planner/<int:pk>/', views_frontend.monthly_plan_detail, name='monthly_plan_detail'),
    path('monthly-planner/<int:pk>/approve/', views_frontend.monthly_plan_approve, name='monthly_plan_approve'),
    path('monthly-planner/<int:pk>/complete/', views_frontend.monthly_plan_complete, name='monthly_plan_complete'),
    path('monthly-planner/<int:pk>/cancel/', views_frontend.monthly_plan_cancel, name='monthly_plan_cancel'),
    path('monthly-planner/report/pdf/', views_frontend.monthly_plan_report_pdf, name='monthly_plan_report_pdf'),
    path('api/investor-requirement/', views_frontend.investor_requirement_api, name='investor_requirement_api'),
    path('monthly-planner/<int:pk>/edit/', views_frontend.monthly_plan_edit, name='monthly_plan_edit'),
    ...
    path('challans/<int:pk>/pdf/', views_frontend.challan_pdf, name='generate_challan_pdf'),
    path('api/risk-assessment/', views_frontend.risk_assessment_api, name='risk_assessment_api'),
    path('ai/dashboard/', views_frontend.ai_dashboard, name='ai_dashboard'),
    path('ai/run-analysis/', views_frontend.ai_run_analysis, name='ai_run_analysis'),
    path('ai/insight/<int:pk>/', views_frontend.ai_insight_detail, name='ai_insight_detail'),
    path('ai/insight/<int:pk>/resolve/', views_frontend.ai_resolve_insight, name='ai_resolve_insight'),
    path('ai/insight/<int:pk>/ignore/', views_frontend.ai_ignore_insight, name='ai_ignore_insight'),
    path('operations/', views_frontend.operations_dashboard, name='operations_dashboard'),
    path('operations/ai-insights/', views_frontend.ai_insights_list, name='ai_insights_list'),
    path('operations/ai-insights/<int:pk>/resolve/', views_frontend.ai_insight_resolve, name='ai_insight_resolve'),
    path('operations/ai-insights/<int:pk>/ignore/', views_frontend.ai_insight_ignore, name='ai_insight_ignore'),
    path('operations/ai-suggestions/', views_frontend.ai_task_suggestions, name='ai_task_suggestions'),
    path('operations/ai-suggestions/<int:pk>/accept/', views_frontend.ai_suggestion_accept, name='ai_suggestion_accept'),
    path('operations/ai-suggestions/<int:pk>/reject/', views_frontend.ai_suggestion_reject, name='ai_suggestion_reject'),
    path('operations/run-ai/', views_frontend.run_ai_analysis, name='run_ai_analysis'),
    path('operations/plans/', views_frontend.operation_plan_list, name='operation_plan_list'),
    path('operations/plans/create/', views_frontend.operation_plan_create, name='operation_plan_create'),
    path('operations/plans/<int:pk>/', views_frontend.operation_plan_detail, name='operation_plan_detail'),
    path('operations/plans/<int:pk>/edit/', views_frontend.operation_plan_edit, name='operation_plan_edit'),
    path('operations/plans/<int:pk>/approve/', views_frontend.operation_plan_approve, name='operation_plan_approve'),
    path('operations/plans/<int:pk>/complete/', views_frontend.operation_plan_complete, name='operation_plan_complete'),
    path('operations/plans/<int:pk>/delete/', views_frontend.operation_plan_delete, name='operation_plan_delete'),
    path('operations/tasks/', views_frontend.task_list, name='task_list'),
    path('operations/tasks/create/', views_frontend.task_create, name='task_create'),
    path('operations/tasks/<int:pk>/', views_frontend.task_detail, name='task_detail'),
    path('operations/tasks/<int:pk>/edit/', views_frontend.task_edit, name='task_edit'),
    path('operations/tasks/<int:pk>/start/', views_frontend.task_start, name='task_start'),
    path('operations/tasks/<int:pk>/complete/', views_frontend.task_complete, name='task_complete'),
    path('operations/tasks/<int:pk>/delete/', views_frontend.task_delete, name='task_delete'),
    path('operations/my-tasks/', views_frontend.my_tasks, name='my_tasks'),
    path('operations/kpi/', views_frontend.kpi_list, name='kpi_list'),
    path('operations/kpi/create/', views_frontend.kpi_create, name='kpi_create'),
    path('operations/kpi/<int:pk>/edit/', views_frontend.kpi_edit, name='kpi_edit'),
    path('operations/kpi/<int:pk>/delete/', views_frontend.kpi_delete, name='kpi_delete'),
    path('operations/checklist/', views_frontend.checklist_today, name='checklist_today'),
    path('operations/checklist/create/', views_frontend.checklist_create, name='checklist_create'),
    path('operations/checklist/<int:pk>/complete/', views_frontend.checklist_complete, name='checklist_complete'),
    path('operations/alerts/', views_frontend.operation_alerts, name='operation_alerts'),
    path('operations/alerts/<int:pk>/read/', views_frontend.alert_mark_read, name='alert_mark_read'),
    path('operations/alerts/<int:pk>/resolve/', views_frontend.alert_resolve, name='alert_resolve'),
    path('api/chatbot/', views_frontend.chatbot_api, name='chatbot_api'),
    path('api/announce-alerts/', views_frontend.announce_alerts_api, name='announce_alerts_api'),
    path('settings/voice-announcement/', views_frontend.voice_announcement_settings, name='voice_announcement_settings'),
    path('ai/purchase-planner/', views_frontend.ai_purchase_planner_dashboard, name='ai_purchase_planner_dashboard'),
    path('ai/purchase-analysis/', views_frontend.ai_purchase_analysis, name='ai_purchase_analysis_api'),
    path('ai/bulk-analysis/', views_frontend.ai_bulk_analysis, name='ai_bulk_analysis_api'), 
    path('ai/accept-suggestion/<int:pk>/', views_frontend.ai_accept_suggestion, name='ai_accept_suggestion'),
    path('ai/reject-suggestion/<int:pk>/', views_frontend.ai_reject_suggestion, name='ai_reject_suggestion'),
    path('ai/cash/dashboard/', views_frontend.ai_cash_dashboard, name='ai_cash_dashboard'),
    path('ai/cash/forecast/', views_frontend.ai_cash_forecast, name='ai_cash_forecast'),
    path('ai/cash/collections/', views_frontend.ai_cash_collections, name='ai_cash_collections'),
    path('ai/cash/alerts/', views_frontend.ai_cash_alerts, name='ai_cash_alerts'),
    path('ai/cash/alerts/<int:pk>/resolve/', views_frontend.ai_cash_alert_resolve, name='ai_cash_alert_resolve'),
    path('ai/cash/health/', views_frontend.ai_cash_health, name='ai_cash_health'),
    path('ai/shareholder/dashboard/', views_frontend.ai_shareholder_dashboard, name='ai_shareholder_dashboard'),
    path('ai/shareholder/scores/', views_frontend.ai_shareholder_scores, name='ai_shareholder_scores'),
    path('ai/shareholder/churn/', views_frontend.ai_shareholder_churn, name='ai_shareholder_churn'),
    path('ai/shareholder/dividend/', views_frontend.ai_dividend_recommendation, name='ai_dividend_recommendation'),
    path('ai/shareholder/alerts/', views_frontend.ai_shareholder_alerts, name='ai_shareholder_alerts'),
    path('ai/shareholder/alerts/<int:pk>/resolve/', views_frontend.ai_shareholder_alert_resolve, name='ai_shareholder_alert_resolve'),
    path('ai/shareholder/forecast/', views_frontend.ai_shareholder_forecast, name='ai_shareholder_forecast'),
    path('ai/board-room/', views_frontend.ai_board_room_dashboard, name='ai_board_room_dashboard'),
    path('ai/board-room/member/<str:member_type>/', views_frontend.ai_board_member_detail, name='ai_board_member_detail'),
    path('ai/board-room/meetings/', views_frontend.ai_board_meetings_list, name='ai_board_meetings_list'),
    path('ai/board-room/meetings/<int:pk>/', views_frontend.ai_board_meeting_detail, name='ai_board_meeting_detail'),
    path('ai/board-room/alerts/', views_frontend.ai_board_alerts, name='ai_board_alerts'),
    path('ai/board-room/alerts/<int:pk>/resolve/', views_frontend.ai_board_alert_resolve, name='ai_board_alert_resolve'),
    path('ai/cso-tech/', views_frontend.ai_cso_tech_dashboard, name='ai_cso_tech_dashboard'),
    path('ai/cso-tech/security/', views_frontend.ai_cso_tech_security, name='ai_cso_tech_security'),
    path('ai/cso-tech/performance/', views_frontend.ai_cso_tech_performance, name='ai_cso_tech_performance'),
    path('ai/cso-tech/bugs/', views_frontend.ai_cso_tech_bugs, name='ai_cso_tech_bugs'),
    path('ai/cso-tech/features/', views_frontend.ai_cso_tech_features, name='ai_cso_tech_features'),
    path('ai/cso-tech/system/', views_frontend.ai_cso_tech_system, name='ai_cso_tech_system'),
    path('cash-strategies/', views_frontend.cash_strategies_list, name='cash_strategies_list'),
    path('cash-strategies/<int:pk>/', views_frontend.cash_strategy_detail, name='cash_strategy_detail'),
    path('cash-strategies/<int:pk>/approve/', views_frontend.cash_strategy_approve, name='cash_strategy_approve'),
    path('cash-strategies/<int:pk>/execute/', views_frontend.cash_strategy_execute, name='cash_strategy_execute'),
    path('cash-strategies/<int:pk>/complete/', views_frontend.cash_strategy_complete, name='cash_strategy_complete'),
    path('cash-strategies/<int:pk>/cancel/', views_frontend.cash_strategy_cancel, name='cash_strategy_cancel'),
    path('strategy-allocations/', 
     views_frontend.strategy_allocations_list, 
     name='strategy_allocations_list'),
     path('strategy-allocations/create/', 
     views_frontend.strategy_allocation_create, 
     name='strategy_allocation_create'),
     path('strategy-allocations/<int:pk>/edit/', 
     views_frontend.strategy_allocation_edit, 
     name='strategy_allocation_edit'),
     path('strategy-allocations/<int:pk>/activate/', 
     views_frontend.strategy_allocation_activate, 
     name='strategy_allocation_activate'),
     path('strategy-allocations/<int:pk>/delete/', 
     views_frontend.strategy_allocation_delete, 
     name='strategy_allocation_delete'),
     path('strategy-allocations/<int:pk>/preview/', 
     views_frontend.strategy_allocation_preview, 
     name='strategy_allocation_preview'),
     path('grn/<int:pk>/reset/', views_frontend.grn_reset_conversion, name='grn_reset_conversion'),
     path('purchases/<int:pk>/pay/', views_frontend.purchase_pay, name='purchase_pay'),
     path('sales/<int:pk>/receive/', views_frontend.sale_receive_payment, name='sale_receive_payment'),
     path('ai/emergency-fund/', views_frontend.emergency_fund_dashboard, name='emergency_fund_dashboard'),
     path('ai/emergency-fund/add/', views_frontend.emergency_fund_add, name='emergency_fund_add'),
     ...
     path('shop/cart/add/', views_customer_portal.add_to_cart, name='add_to_cart'),
     path('shop/cart/update/', views_customer_portal.update_cart, name='update_cart'),
     path('shop/cart/remove/<int:product_id>/', views_customer_portal.remove_from_cart, name='remove_from_cart'),
     path('shop/checkout/', views_customer_portal.checkout, name='checkout'),
